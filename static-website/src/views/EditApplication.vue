<template>
  <div>
    ...
    <b-container>
      ...
      <b-row>
        <b-col>
          <b-card title="SDU Sandbox App details">
            <b-form @submit.prevent="onSubmit()">
              <b-form-group
                id="author-group"
                label="Author"
                label-for="author"
                description="Use a name you'd like to publish your SDU Sandbox App under.
              ...
              <b-form-group
                ...
                description="Point people to your SDU Sandbox App's home page (e.g. your GitHub repository URL)."
              >
              ...
              <b-form-group
                ...
                description="Help people understand what your SDU Sandbox App should be used for, and how it works."
              >
                <b-form-textarea id="description" v-model="form.description" required rows="3" />
              </b-form-group>

              <b-button type="submit" variant="primary" class="float-right ml-2">Save SDU Sandbox Application</b-button>
              <b-button
                id="cancel"
